			...
			<div class="flex items-center justify-center">
							<div class="flex auto">
									<form action="{{ route('statuses.store') }}" method="POST">
										<h1 class="block text-gray-700 font-bold mb-2 text-xl text-center">Add Status: </h1>
										<br>
										@csrf
										<div class="mb-4">
											<label class="block text-gray-700 text-sm font-bold mb-2">Name: </label>
											<input type="text" name="name" class="w-full h-10 px-3 mb-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline">
										</div>
